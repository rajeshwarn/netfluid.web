...
namespace Mustache
{
    ...
    internal sealed class FormatCompiler
    {
        ...
        public void RegisterTag(TagDefinition definition, bool isTopLevel)
        {
            ...
            {
                throw new ArgumentException("Duplicate tage definition "+definition.Name, "definition");
            }
            ...
            string format, int formatIndex)
        {
            while (true)
            {
                ...
                if (!match.Success)
                {
                    ...
                    {
                        throw new FormatException("Missing closing tag "+tagDefinition.Name);
                    }
                    break;
                }
                ...
                else if (match.Groups["open"].Success)
                {
                    ...
                    {
                        throw new FormatException("Unknow tag "+tagName);
                    }
                ...
                {
                    throw new FormatException("Unknow tag "+match.Value);
                }
            }
            return formatIndex;
        }
        ...
        private ArgumentCollection getArguments(TagDefinition definition, Match match, List<Context> context)
        {
            ...
            {
                throw new FormatException("Wrong number of arguments "+definition.Name);
            }
