...
namespace Netfluid.DB
{
    public partial class BsonMapper
    {
        ...
        private object Deserialize(Type type, BsonValue value)
        {
            ...
            else if (DB.Reflection.IsNullable(type))
            {
                type = DB.Reflection.UnderlyingTypeOf(type);
            }
            ...
            else if (value.IsDocument)
            {
                ...
                var o = DB.Reflection.CreateInstance(type);
        ...
        {
            var itemType = DB.Reflection.UnderlyingTypeOf(type);
            var list = (IList)DB.Reflection.CreateInstance(type);
