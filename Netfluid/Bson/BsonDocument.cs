...
namespace Netfluid.Bson
{
    ...
    {
        public const int MAX_DOCUMENT_SIZE = 256 * Netfluid.DB.BasePage.PAGE_AVAILABLE_BYTES; // limits in 1.044.224b max document size to avoid large documents, memory usage and slow performance
        ...
        {
            return Netfluid.Json.JsonSerializer.Serialize(this);
        }
