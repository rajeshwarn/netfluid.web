...
namespace Netfluid.Json
{
    ...
    /// <summary>
    /// Exception raised when <see cref="JsonSerializer" /> encounters an invalid token.
    /// </summary>
    ...
    public static class JsonSerializer
    {
        ...
        {
            var bag = GetBagForObject(instance.GetType(), instance);
        ...
        {
            var bag = GetBagForObject(typeof(T), instance);
            var sb = new StreamWriter(stream);
            SerializeItem(sb, bag);
        }
        ...
        internal static IDictionary<string, object> GetBagForObject(Type type, object instance)
        {
            ...
            foreach (var info in map)
            {
                ...
                if (info.GetMethod.GetParameters().Length > 0) continue;
        ...
        internal static void SerializeItem(TextWriter sb, object item)
        {
            ...
            if (item is bool)
            {
                sb.Write(((bool)item).ToString().ToLower());
                return;
            }
        ...
        internal static void SerializeDateTime(TextWriter sb)
        {
        ...
        internal static void SerializeArray(object item, TextWriter sb)
        {
        ...
        internal static void SerializeObject(object item, TextWriter sb)
        {
        ...
        internal static void SerializeString(TextWriter sb, object item)
        {
            sb.Write("\"");
        ...
        {
            var symbol = data[index];
            var token = GetTokenFromSymbol(symbol, JsonToken.Unknown);
