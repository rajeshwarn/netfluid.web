...
namespace FluidDB
{
    ...
    public abstract class Query
    {
        ...
        /// <summary>
        /// Returns all objects using Id PK
        /// </summary>
        ...
        internal abstract IEnumerable<IndexNode> Execute(FluidDatabase engine, CollectionIndex index);

        internal virtual IEnumerable<IndexNode> Run(FluidDatabase engine, CollectionPage col)
        {
