...
namespace FluidDB
{
    ...
    internal class JournalService
    {
        ...
        public JournalService(DbSettings connectionString, CacheService cache)
        {
        ...
        public void CreateJournalFile(Action action)
        {
            ...
            using (var stream = File.Open(_connectionString.JournalFilename, FileMode.Create, FileAccess.ReadWrite, FileShare.None))
            {
